...
LRESULT CALLBACK WndProc(HWND hwnd,UINT message,WPARAM wParam,LPARAM lParam) {
    ...
    case WM_PAINT:
        ...
        drawEllipse(400, 200, 25, 25);
        drawEllipse(400, 200, 50, 50);
        drawEllipse(400, 200, 75, 75);
        drawEllipse(400, 200, 100,100);
        drawEllipse(400, 200, 125,125);

        drawEllipse(150, 150, 100, 100);
        drawEllipse(150, 150, 40, 40);
        drawEllipse(150+40, 150, 40, 40);
        drawEllipse(150-40, 150, 40, 40);
        drawEllipse(150, 150+40, 40, 40);
        drawEllipse(150, 150-40, 40, 40);
