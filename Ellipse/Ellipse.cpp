...
LRESULT CALLBACK WndProc(HWND hwnd,UINT message,WPARAM wParam,LPARAM lParam) {
    ...
    case WM_PAINT:
        ...
        drawEllipse(500, 300, 400, 100);
        drawEllipse(500, 300, 20, 90);
        drawEllipse(500+320, 300, 30, 20);
        drawEllipse(500+250, 300, 20, 60);
        drawEllipse(500+190, 300, 20, 75);
        drawEllipse(500+125, 300, 20, 85);

        drawEllipse(500+62, 300-20, 25, 15);
        drawEllipse(500+62, 300-70, 25, 15);
        drawEllipse(500+62, 300+20, 25, 15);
        drawEllipse(500+62, 300+70, 25, 15);
        drawEllipse(500-320, 300, 30, 20);
        drawEllipse(500-250, 300, 20, 60);
